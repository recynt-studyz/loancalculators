...
const tools = [
  ...
  { href: '/auto-loan', label: 'Auto' },
  { href: '/student-loan', label: 'Student' },
...
export default function CalcNav() {
  ...
  const toggleDark = () => {
    ...
    try { localStorage.setItem('loancalculators-theme', next ? 'dark' : 'light') } catch { /* ignore */ }
  }

  return (
    <nav aria-label="Financial calculator navigation" className="px-4 sm:px-6 overflow-x-auto">
